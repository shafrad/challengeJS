let order = [
  ...
  console.log('\n')
  //console.log(order[0], order[2], order[4])
  let res = order[0].items[0].price + order[0].items[1].price +
  order[2].items[0].price + order[2].items[1].price +
  order[4].items[0].price + order[4].items[1].price;
  console.log('Total purchases made by Ary is : ' + res)
  console.log('\n')
  console.log(order[5].customer)
